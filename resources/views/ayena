...
<html
  ...
  <body>
      ...
      <div class="container">
        <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-4">
          ...
          <div class="navbar-brand app-brand demo d-flex py-0 me-4">
            ...
            <img src="assets/img/favicon/favicon.png" alt="Logo" height="60" class="me-2">
              <span class="app-brand-text demo menu-text fw-bold ms-2 ps-1">Gwen Coffee</span>
            </a>
          </div>
            ...
            <div id="heroDashboardAnimation" class="hero-animation-img">
              <a href="../vertical-menu-template/app-ecommerce-dashboard.html" target="_blank">
                <div id="heroAnimationImg" class="position-relative hero-dashboard-img">
                  <img
                    src="../../assets/img/front-pages/landing-page/hero-dashboard-light.jpg"
                    alt="hero dashboard"
                    class="animation-img"
    ...
    <section id="productSection" class="section-py landing-features">
    <div class="container">
        <div class="text-center mb-3 pb-1">
        <span class="badge bg-label-primary">Our Products</span>
        </div>
        <h3 class="text-center mb-1">Explore Our Featured Products</h3>
        <p class="text-center mb-3 mb-md-5 pb-3">
        Browse our selection of high-quality items available now.
        </p>
        <div class="row gx-4 gy-5">
        <!-- Product 1 -->
        <div class="col-lg-4 col-sm-6 text-center">
            <div class="card h-100 shadow-sm">
            <img src="/assets/img/front-pages/landing-page/matcha.jpg" class="card-img-top" alt="Product 1">
            <div class="card-body">
                <h5 class="card-title">Product One</h5>
                <p class="card-text">A short description of the product goes here.</p>
        ...
        <div class="col-lg-4 col-sm-6 text-center">
            <div class="card h-100 shadow-sm">
            <img src="/assets/img/front-pages/landing-page/strawberry.jpg" class="card-img-top" alt="Product 2">
            <div class="card-body">
        ...
        <div class="col-lg-4 col-sm-6 text-center">
            <div class="card h-100 shadow-sm">
            <img src="/assets/img/front-pages/landing-page/matcha.jpg" class="card-img-top" alt="Product 3">
            <div class="card-body">
        ...
        <div class="col-lg-4 col-sm-6 text-center">
            <div class="card h-100 shadow-sm">
            <img src="/assets/img/front-pages/landing-page/strawberry.jpg" class="card-img-top" alt="Product 4">
            <div class="card-body">
        ...
        <div class="col-lg-4 col-sm-6 text-center">
            <div class="card h-100 shadow-sm">
            <img src="/assets/img/front-pages/landing-page/matcha.jpg" class="card-img-top" alt="Product 5">
            <div class="card-body">
        ...
        <div class="col-lg-4 col-sm-6 text-center">
            <div class="card h-100 shadow-sm">
            <img src="/assets/img/front-pages/landing-page/strawberry.jpg" class="card-img-top" alt="Product 6">
            <div class="card-body">
                <h5 class="card-title">Product Six</h5>
                <p class="card-text">A short description of the product goes here.</p>
                <button class="btn btn-primary">Add to Cart</button>
            </div>
            </div>
